...
class BaseConfig:
    ...
    ONE_H10_MARKET_DATA_FRESHNESS_SECONDS = _as_float(
        os.getenv("ONE_H10_MARKET_DATA_FRESHNESS_SECONDS"),
        ONE_H10_FEATURE_REFRESH_SECONDS,
    )
    ONE_H10_MIN_CANDLES_PER_HORIZON = _as_int(os.getenv("ONE_H10_MIN_CANDLES_PER_HORIZON"), 40)
    ...
    ONE_H10_START_SYNC_FEATURES = _as_bool(os.getenv("ONE_H10_START_SYNC_FEATURES"), default=True)
    ONE_H10_READINESS_REFRESH_MARKET_DATA = _as_bool(os.getenv("ONE_H10_READINESS_REFRESH_MARKET_DATA"), default=True)
    ...
    ONE_H10_EDGE_BUFFER_BPS = _as_float(os.getenv("ONE_H10_EDGE_BUFFER_BPS"), 2.0)
    ...
    VAULT_CYCLE_CONVERSION_USER_ID = _as_int(os.getenv("VAULT_CYCLE_CONVERSION_USER_ID"), 0)
    VAULT_CYCLE_CONVERSION_CONNECTION_ID = _as_int(os.getenv("VAULT_CYCLE_CONVERSION_CONNECTION_ID"), 0)
    VAULT_CYCLE_STABLECOIN_MAX_SLIPPAGE_BPS = _as_float(os.getenv("VAULT_CYCLE_STABLECOIN_MAX_SLIPPAGE_BPS"), 10.0)
    WALLET_CONVERSION_PROVIDER_ENABLED = _as_bool(os.getenv("WALLET_CONVERSION_PROVIDER_ENABLED"), default=False)
    WALLET_CONVERSION_PROVIDER_KIND = os.getenv("WALLET_CONVERSION_PROVIDER_KIND", "").strip().lower()
    WALLET_CONVERSION_SIGNER_TRANSACTIONS_ENABLED = _as_bool(
        os.getenv("WALLET_CONVERSION_SIGNER_TRANSACTIONS_ENABLED"),
        default=False,
    )
    VAULT_CYCLE_ONEINCH_AUTO_CONVERSION_ENABLED = _as_bool(
        os.getenv("VAULT_CYCLE_ONEINCH_AUTO_CONVERSION_ENABLED"),
        default=False,
    )
    VAULT_CYCLE_ONEINCH_API_URL = (
        os.getenv("VAULT_CYCLE_ONEINCH_API_URL")
        or os.getenv("ONEINCH_API_URL")
        or "https://api.1inch.dev/swap/v6.1"
    ).strip().rstrip("/")
    VAULT_CYCLE_ONEINCH_API_KEY = (
        os.getenv("VAULT_CYCLE_ONEINCH_API_KEY")
        or os.getenv("ONEINCH_API_KEY")
        or os.getenv("WALLET_CONVERSION_1INCH_API_KEY")
        or ""
    ).strip()
    VAULT_CYCLE_ONEINCH_NETWORK = (
        os.getenv("VAULT_CYCLE_ONEINCH_NETWORK")
        or os.getenv("VAULT_CYCLE_HYPERLIQUID_AUTO_FUNDING_NETWORK")
        or "Arbitrum"
    ).strip() or "Arbitrum"
    VAULT_CYCLE_ONEINCH_CONFIRMATION_ATTEMPTS = _as_int(os.getenv("VAULT_CYCLE_ONEINCH_CONFIRMATION_ATTEMPTS"), 3)
    VAULT_CYCLE_ONEINCH_CONFIRMATION_POLL_SECONDS = _as_float(
        os.getenv("VAULT_CYCLE_ONEINCH_CONFIRMATION_POLL_SECONDS"),
        2.0,
    )
    ...
    VAULT_CYCLE_HYPERLIQUID_AUTO_FUNDING_TIMEOUT_SECONDS = _as_float(
        os.getenv("VAULT_CYCLE_HYPERLIQUID_AUTO_FUNDING_TIMEOUT_SECONDS"),
        45.0,
    )
    VAULT_CYCLE_HYPERLIQUID_AUTO_FUNDING_POLL_SECONDS = _as_float(
        os.getenv("VAULT_CYCLE_HYPERLIQUID_AUTO_FUNDING_POLL_SECONDS"),
        2.0,
    )
    VAULT_CYCLE_HYPERLIQUID_AUTO_FUNDING_NETWORK = (
        os.getenv("VAULT_CYCLE_HYPERLIQUID_AUTO_FUNDING_NETWORK", "Arbitrum").strip() or "Arbitrum"
    )
    HYPERLIQUID_BRIDGE2_CONTRACT_ADDRESS = os.getenv(
        "HYPERLIQUID_BRIDGE2_CONTRACT_ADDRESS",
    ...
    WALLET_EVM_FALLBACK_CONTRACT_GAS_LIMIT = _as_int(os.getenv("WALLET_EVM_FALLBACK_CONTRACT_GAS_LIMIT"), 450_000)
    ...
    def export_defaults(cls) -> dict[str, Any]:
        ...
        return {
            ...
            "ONE_H10_MARKET_DATA_FRESHNESS_SECONDS": cls.ONE_H10_MARKET_DATA_FRESHNESS_SECONDS,
            "ONE_H10_MIN_CANDLES_PER_HORIZON": cls.ONE_H10_MIN_CANDLES_PER_HORIZON,
            ...
            "ONE_H10_READINESS_REFRESH_MARKET_DATA": cls.ONE_H10_READINESS_REFRESH_MARKET_DATA,
            ...
            "ONE_H10_EDGE_BUFFER_BPS": cls.ONE_H10_EDGE_BUFFER_BPS,
            ...
            "VAULT_CYCLE_CONVERSION_USER_ID": cls.VAULT_CYCLE_CONVERSION_USER_ID,
            "VAULT_CYCLE_CONVERSION_CONNECTION_ID": cls.VAULT_CYCLE_CONVERSION_CONNECTION_ID,
            "VAULT_CYCLE_STABLECOIN_MAX_SLIPPAGE_BPS": cls.VAULT_CYCLE_STABLECOIN_MAX_SLIPPAGE_BPS,
            "WALLET_CONVERSION_PROVIDER_ENABLED": cls.WALLET_CONVERSION_PROVIDER_ENABLED,
            "WALLET_CONVERSION_PROVIDER_KIND": cls.WALLET_CONVERSION_PROVIDER_KIND,
            "WALLET_CONVERSION_SIGNER_TRANSACTIONS_ENABLED": cls.WALLET_CONVERSION_SIGNER_TRANSACTIONS_ENABLED,
            "VAULT_CYCLE_ONEINCH_AUTO_CONVERSION_ENABLED": cls.VAULT_CYCLE_ONEINCH_AUTO_CONVERSION_ENABLED,
            "VAULT_CYCLE_ONEINCH_API_URL": cls.VAULT_CYCLE_ONEINCH_API_URL,
            "VAULT_CYCLE_ONEINCH_API_KEY": "[configured]" if cls.VAULT_CYCLE_ONEINCH_API_KEY else "",
            "VAULT_CYCLE_ONEINCH_NETWORK": cls.VAULT_CYCLE_ONEINCH_NETWORK,
            ...
            "VAULT_CYCLE_HYPERLIQUID_AUTO_FUNDING_TIMEOUT_SECONDS": cls.VAULT_CYCLE_HYPERLIQUID_AUTO_FUNDING_TIMEOUT_SECONDS,
            "VAULT_CYCLE_HYPERLIQUID_AUTO_FUNDING_POLL_SECONDS": cls.VAULT_CYCLE_HYPERLIQUID_AUTO_FUNDING_POLL_SECONDS,
            "VAULT_CYCLE_HYPERLIQUID_AUTO_FUNDING_NETWORK": cls.VAULT_CYCLE_HYPERLIQUID_AUTO_FUNDING_NETWORK,
            "HYPERLIQUID_BRIDGE2_CONTRACT_ADDRESS": cls.HYPERLIQUID_BRIDGE2_CONTRACT_ADDRESS,
            ...
            "WALLET_EVM_FALLBACK_CONTRACT_GAS_LIMIT": cls.WALLET_EVM_FALLBACK_CONTRACT_GAS_LIMIT,
