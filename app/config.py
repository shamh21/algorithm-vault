...
class BaseConfig:
    ...
    FIRST_CANARY_MAX_NOTIONAL_USDT = _as_float(os.getenv("FIRST_CANARY_MAX_NOTIONAL_USDT"), 1.0)
    FIRST_CANARY_FALLBACK_MAX_NOTIONAL_USDT = _as_float(os.getenv("FIRST_CANARY_FALLBACK_MAX_NOTIONAL_USDT"), 2.0)
    ...
    LIVE_MICRO_CANARY_MAX_NOTIONAL_USD = _as_float(os.getenv("LIVE_MICRO_CANARY_MAX_NOTIONAL_USD"), 10.0)
    ...
    ONE_H10_FEATURE_TIMEFRAMES = _parse_csv(os.getenv("ONE_H10_FEATURE_TIMEFRAMES"), ["15m", "1h", "4h"])
    ...
    def export_defaults(cls) -> dict[str, Any]:
        ...
        return {
            ...
            "FIRST_CANARY_MAX_NOTIONAL_USDT": cls.FIRST_CANARY_MAX_NOTIONAL_USDT,
            "FIRST_CANARY_FALLBACK_MAX_NOTIONAL_USDT": cls.FIRST_CANARY_FALLBACK_MAX_NOTIONAL_USDT,
            ...
            "LIVE_MICRO_CANARY_MAX_NOTIONAL_USD": cls.LIVE_MICRO_CANARY_MAX_NOTIONAL_USD,
