...
class BaseConfig:
    ...
    WALLET_BUY_INTERNAL_TREASURY_SIGNER_ENABLED = _as_bool(
        os.getenv("WALLET_BUY_INTERNAL_TREASURY_SIGNER_ENABLED"),
        default=True,
    )
    ...
    def export_defaults(cls) -> dict[str, Any]:
        ...
        return {
            ...
            "CRON_SECRET": "[configured]" if cls.CRON_SECRET else "",
            ...
            "WALLET_BUY_INTERNAL_TREASURY_SIGNER_ENABLED": cls.WALLET_BUY_INTERNAL_TREASURY_SIGNER_ENABLED,
