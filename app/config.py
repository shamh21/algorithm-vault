...
class BaseConfig:
    ...
    ONE_H10_MIN_ORDER_NOTIONAL_FLOOR_ENABLED = _as_bool(
        os.getenv("ONE_H10_MIN_ORDER_NOTIONAL_FLOOR_ENABLED"),
        default=True,
    )
    ONE_H10_MIN_ORDER_NOTIONAL_USD = _as_float(os.getenv("ONE_H10_MIN_ORDER_NOTIONAL_USD"), 0.0)
