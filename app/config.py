...
class BaseConfig:
    ...
    KUCOIN_NATIVE_STATIC_EGRESS_ENABLED = _as_bool(os.getenv("KUCOIN_NATIVE_STATIC_EGRESS_ENABLED"), default=False)
    ...
    def export_defaults(cls) -> dict[str, Any]:
        ...
        return {
            ...
            "KUCOIN_NATIVE_STATIC_EGRESS_ENABLED": cls.KUCOIN_NATIVE_STATIC_EGRESS_ENABLED,
