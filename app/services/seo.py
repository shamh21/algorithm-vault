...
BRAND_NAME = "AlgVault"
SOCIAL_IMAGE_PATH = "/icons/algvault-social.png"
...
PUBLIC_PAGES: dict[str, PublicSeoPage] = {
    ...
    "features": PublicSeoPage(
        ...
        disclaimer=("AlgVault provides automation, analytics, and operational tooling. It does not promise trading outcomes."),
    ),
    "pricing": PublicSeoPage(
        ...
        highlights=(
            ...
            {"label": "Billing", "value": "No hype", "detail": "No guaranteed-return claims or personalized financial guidance."},
        ...
        disclaimer=(
            "Pricing content describes platform access and operational tooling only. AlgVault does not promise returns "
